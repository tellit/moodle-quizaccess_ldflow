...
/**
 * Provides the information to backup the ldflow quiz access plugin.
 *
 * If this plugin is requires, a single
 * <quizaccess_ldflow><ldflow>1</ldflow></quizaccess_ldflow> tag
 * will be added to the XML in the appropriate place. Otherwise nothing will be
 * added. This matches the DB structure.
 */
class backup_quizaccess_ldflow_subplugin extends backup_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $subplugintablesettings = new backup_nested_element('quizaccess_ldflow',
            null, array('skipviewonfirstattempt', 'skipsummary', 'skipreview', 'skipreviewandreturn'));
        ...
        $subplugintablesettings->set_source_table('quizaccess_ldflow',
